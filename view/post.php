     ...
     <div class=" container my-2">
          <nav class="navbar navbar-expand-lg py-4 rounded">
               <div class="container-fluid">
                    <a class="navbar-brand" href="#"><i class="bi bi-table p-2"></i>Entry Biografi</a>
               </div>
          </nav>
     </div>
     <div class="container w-50 bg-light py-3 px-5 shadow rounded my-5">
          <form method="post" action="../config/post.php">
               ...
               <div class="mb-3">
                    ...
                    <input type="text" class="form-control no_hp" name="telepon" max="12" autocomplete="off" required>
               </div>
               <div class="mb-3">
                    <label for="jalan" class="form-table p-2">jalan</label>
                    <input type="text" class="form-control" name="jalan" autocomplete="off" required>
               </div>
               <div class="mb-3">
                    <label for="kodepos" class="form-table p-2">Kode Pos</label>
                    <input type="text" class="form-control pos" name="kodepos" autocomplete="off" required>
               </div>
               <div class="mb-3">
               ...
               <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="provinsi" autocomplete="off" required>
               </div>
               <div class="mb-3">
